...
import { BookOpen, BookText, Atom, GraduationCap, Globe, Flag } from 'lucide-react'; // Removed Atom, Globe if no longer needed by other parts
  ...
  const handleSubjectClick = (subjectName: string) => {
    ...
    switch(subjectName) {
      ...
      case 'Gujarati':
        navigate('/gujarati');
        break;
      // Removed cases for Science and Social Science
      default:
        console.log(`No specific navigation defined for ${subjectName}`);
    }
  };

  // Removed Science and Social Science from the array
  const subjects = [
  ...
  return (
    <section className="relative py-12 md:py-20 overflow-hidden bg-background text-foreground">
      <div className="container mx-auto px-4 relative z-10">
        ...
        {/* Adjusted grid columns for potentially fewer items */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mt-12"> {/* Changed lg:grid-cols-3 to lg:grid-cols-4 */}
